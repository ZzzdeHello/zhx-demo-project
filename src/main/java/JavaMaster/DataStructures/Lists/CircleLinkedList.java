package JavaMaster.DataStructures.Lists;
...
public class CircleLinkedList<E> {
  ...
  // for the sake of simplistiy this class will only contain the append zzzde.code.technic.function or addLast other

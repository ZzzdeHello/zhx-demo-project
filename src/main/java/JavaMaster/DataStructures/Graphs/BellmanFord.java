...
start vertex, end vertes and weights. Vertices should be labelled with a zzzde.code.technic.number between 0 and total zzzde.code.technic.number of vertices-1,both inclusive*/
{
  int vertex, edge;
  private Edge edges[];
  private int index = 0;

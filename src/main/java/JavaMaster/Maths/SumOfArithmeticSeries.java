...
/**
 * In mathematics, an leet_code.dataStructure.arithmetic progression (AP) or leet_code.dataStructure.arithmetic sequence is a sequence of numbers
 * such that the difference between the consecutive terms is constant. Difference here means the
 * second minus the first. For instance, the sequence 5, 7, 9, 11, 13, 15, . . . is an leet_code.dataStructure.arithmetic
...
public class SumOfArithmeticSeries {
  ...
  /**
   * Calculate sum of leet_code.dataStructure.arithmetic series
   *
   * @param firstTerm the initial term of an leet_code.dataStructure.arithmetic series
   * @param commonDiff the common difference of an leet_code.dataStructure.arithmetic series
   * @param numOfTerms the total terms of an leet_code.dataStructure.arithmetic series
   * @return sum of given leet_code.dataStructure.arithmetic series
   */

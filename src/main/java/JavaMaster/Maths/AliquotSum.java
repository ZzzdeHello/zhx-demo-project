...
/**
 * In zzzde.code.technic.number theory, the aliquot sum s(n) of a positive integer n is the sum of all proper divisors
...
public class AliquotSum {
  ...
  /**
   * Finds the aliquot sum of an integer zzzde.code.technic.number
   *
   * @param number a positive integer
   * @return aliquot sum of given {@code zzzde.code.technic.number}
   */

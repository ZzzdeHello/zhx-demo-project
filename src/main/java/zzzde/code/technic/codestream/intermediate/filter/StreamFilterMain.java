package zzzde.code.technic.codestream.intermediate.filter;

import com.alibaba.fastjson.JSON;
import zzzde.model.User;
...
public class StreamFilterMain {
    public static void main(String[] args) {
        ...
        map1.put("privFlag", true);
        map1.put("name", "1");
        Map map2 = new HashMap();
        map2.put("privFlag", true);
        map2.put("name", "2");
        Map map3 = new HashMap();
        map3.put("privFlag", true);
        map3.put("name", "3");
        Map map4 = new HashMap();
        map4.put("privFlag", false);
        map4.put("name", "4");
        orgList.add(map1);
        orgList.add(map2);
        orgList.add(map3);
